...
// Optymalizacja: Użycie matematyki całkowitoliczbowej zamiast zmiennoprzecinkowej (float) dla wydajności (AVR)
const int filter_beta_num = 3;
const int filter_beta_den = 10;
...
void loop() {
  ...
  // Bolt: Zoptymalizowano matematykę na stałoprzecinkową (int), uwalniając cenne cykle CPU i pamięć Flash na AVR
